...
INSERT INTO "new_QuoteRequest" ("archivedAt", "createdAt", "email", "height", "id", "message", "name", "number", "phone", "productId", "status", "userId", "width") SELECT "archivedAt", "createdAt", "email", "height", "id", "message", "name", "number", "phone", "productId", "status", "userId", "width" FROM "QuoteRequest";
