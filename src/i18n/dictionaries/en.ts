...
export const en: Dictionary = {
  ...
  adminUi: {
    ...
    funnelSteps: { catalog: "Catalog view", product: "Product page", configurator: "Configurator opened", completed: "Configuration completed", cart: "Added to cart", checkout: "Checkout started", order: "Order" },
    discount: { percentage: "Percentage", amount: "Amount", service: "Service", allCatalog: "Entire catalog", smartDoors: "Smart doors", freeInstallation: "Free installation", threeDoors: "3+ doors" },
  },
