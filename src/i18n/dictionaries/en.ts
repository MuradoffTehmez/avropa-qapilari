...
export const en: Dictionary = {
  ...
  pageMeta: {
    ...
    measurement: {
      ...
      description:
        "Free measurement service. A technician comes to your address and takes exact dimensions.",
    },
    quote: {
      title: "Request a quote",
      description:
        "Get a quote for custom sizes, bulk orders and special requirements.",
    },
    showroom: {
      title: "Showroom",
      description:
    ...
    projects: {
      title: "Projects",
      description:
        "Doors we have installed in villas, apartments, offices and commercial buildings.",
    },
    brands: {
      title: "Brands",
      description:
    ...
    blog: {
      title: "Blog",
      description:
        "Guides on choosing a door, security classes, smart locks and maintenance.",
    },
    faq: {
    ...
    contact: {
      title: "Contact",
      description:
        "Ask a question and our operator will answer. Measurement, installation and repair enquiries.",
    },
    cart: { title: "Cart" },
  ...
  home: {
    ...
    categoriesText:
      "A dedicated solution for every interior and every entrance.",
  ...
  services: {
    ...
    delivery: "Delivery",
    deliveryText:
      "Safe delivery of doors and accessories across Baku and the regions.",
    installation: "Installation",
    installationText: "Installation to standard by certified fitters.",
    repair: "Repair",
    repairText:
      "Lock, hinge, frame and smart lock repair, spare part replacement.",
    warranty: "Warranty",
    warrantyText:
      "Warranty registered to a serial number with a full service history.",
    maintenance: "Maintenance",
    ...
    ctaText:
      "From measurement to installation, from warranty to repair — we run every stage through one channel.",
  },
  ...
  serviceDetail: {
    ...
    prices: "Prices",
    priceNote:
      "Prices are indicative and may change depending on the property.",
    measurement: {
  ...
  showroom: {
    ...
    visitText:
      "You can drop in without an appointment, but booking means no waiting.",
  ...
  process: {
    ...
    step1: "Measurement",
    step1Text:
      "A technician visits, measures the opening and recommends matching models.",
    step1Meta: "Free with an order",
    step2: "Configuration",
    step2Text:
      "You choose colour, lock, handle and accessories, and see the price instantly.",
    step2Meta: "Online or in the showroom",
    step3: "Production",
    step3Text:
      "The order goes to the European factory and is built to your dimensions.",
    step3Meta: "3–35 working days",
    step4: "Installation",
    step4Text:
      "A certified crew installs the door, adjusts it and clears the site.",
    step4Meta: "From 120 AZN",
    step5: "Warranty",
    step5Text:
      "The door gets a serial number; every service record is tied to it.",
  ...
  taxonomy: {
    ...
    brandDescriptions: {
      ...
      belveder:
        "European-made entrance doors chosen for their price-to-quality balance.",
      lumia: "Glass and aluminium structures for offices and loft interiors.",
    },
    productShort: {
      "MIL-720":
        "Multi-layer steel construction, 42 dB sound insulation and RC3 certification.",
      "NOR-900":
        "A thermal figure of 0.79 W/m²K, RC4 certification and a 10-year warranty.",
      ...
      "BEL-520":
        "Two independent locking systems, an armoured plate and an anti-drill cylinder.",
      "SMG-S1":
        "Factory-fitted Smart Lock X2 with fingerprint and mobile app control.",
      "LUM-150":
        "Black aluminium grid and clear glass — the classic of loft interiors.",
  ...
  product: {
    ...
    colorsHint:
      "Exterior and interior colours are selected separately. The colours below are available in the configurator.",
    ...
    warrantyQr:
      "Each door receives a unique serial number. Use the QR code on the door to check its warranty status and service history at any time.",
    warrantyExclusions:
      "The warranty does not cover mechanical damage, misuse or third-party intervention.",
  ...
  configurator: {
    ...
    hints: {
      ...
      OPENING_DIRECTION:
        "Stand in front of the door and choose the side the hinges are on.",
      PANEL_STYLE:
        "Surface milling and division lines — shown in the preview straight away.",
      ...
      GLASS_PATTERN:
        "Sandblasted pattern — available only when glazing is selected.",
      ...
      SMART_LOCK:
        "An electronic lock works only with a compatible mechanical lock.",
    ...
    priceUnavailable:
      "The price could not be confirmed right now. The amount shown is a preliminary estimate.",
    saveFailed: "The configuration was not saved",
    notCompatible:
      "This option is not compatible with your current configuration",
    ...
    constructionLayers: {
      s1: { name: "Outer steel sheet", role: "Impact-resistant skin" },
      s2: { name: "Anti-corrosion primer", role: "Moisture protection" },
      s3: { name: "Reinforcing ribs", role: "Anti-deformation frame" },
      s4: { name: "Mineral wool", role: "Sound and thermal insulation" },
      s5: { name: "Vapour barrier", role: "Against condensation" },
      s6: { name: "Inner steel sheet", role: "Structural integrity" },
      s7: { name: "MDF facing panel", role: "Decorative interior surface" },
      s8: { name: "Finish / veneer", role: "Colour and texture" },
      c1: { name: "Composite skin", role: "UV and weather resistance" },
      c2: { name: "Aluminium profile", role: "Dimensional stability" },
      c3: { name: "Thermal break", role: "Prevents heat loss" },
      c4: { name: "Polyurethane foam", role: "0.79 W/m²K thermal core" },
      c5: { name: "Inner aluminium profile", role: "Structure" },
      c6: { name: "Interior panel", role: "Decorative surface" },
      w1: { name: "Lacquer / oil finish", role: "Surface protection" },
      w2: { name: "Solid oak lamella", role: "Exterior face layer" },
      w3: { name: "Cross-laminated core", role: "Warp resistance" },
      w4: { name: "Solid oak lamella", role: "Interior face layer" },
      w5: { name: "Lacquer / oil finish", role: "Surface protection" },
      m1: { name: "Enamel finish", role: "Scratch resistance" },
      m2: { name: "MDF board", role: "Exterior face" },
      m3: { name: "Honeycomb filler", role: "Lightweight core" },
      m4: { name: "MDF board", role: "Interior face" },
      m5: { name: "Enamel finish", role: "Scratch resistance" },
      a1: { name: "Anodised aluminium", role: "Exterior profile" },
      a2: { name: "Thermal break", role: "Heat separator" },
      a3: { name: "Tempered glass unit", role: "Light-transmitting core" },
      a4: { name: "Thermal break", role: "Heat separator" },
      a5: { name: "Anodised aluminium", role: "Interior profile" },
      g1: { name: "Tempered glass", role: "Outer pane" },
      g2: { name: "PVB interlayer", role: "Against breakage" },
      g3: { name: "Tempered glass", role: "Inner pane" },
    },
    showLayer: "show",
    hideLayer: "hide",
    ...
    sharedPrivacy:
      "This link carries only the door options — no personal data is shared.",
    sharedInvalid: "Configuration not found",
    sharedInvalidHint:
      "The link may be incomplete or outdated. Build your own door in the configurator.",
  ...
  cart: {
    ...
    emptyHint:
      "Pick a door from the catalogue or build your own in the configurator.",
    itemCount: "items",
  ...
  checkout: {
    ...
    signInPrompt:
      "Sign in if you have an account — your details fill in automatically.",
    ...
    installationAppointmentNotice:
      "If installation is selected, a separate installation appointment is created after delivery.",
  ...
  repair: {
    ...
    exactTimeNotice:
      "The exact time is confirmed by an operator. Technician assignment and time conflicts are checked in the system.",
    files: "Files",
    fileUnit: "file(s)",
  },
  ...
  measurement: {
    title: "Book a measurement",
    subtitle:
      "A technician visits and takes exact measurements — free of charge.",
    ...
    notifyNote:
      "Once the technician's arrival time is confirmed you will get an SMS and an email.",
    timeTitle: "Time",
  },
  ...
  quote: {
    ...
    messagePlaceholder:
      "The property, requirements, colour, lock system, installation needs…",
  ...
  auth: {
    ...
    signInText:
      "Track your orders, open saved designs and manage service requests.",
    register: "Create account",
    registerTitle: "Create a new account",
    registerText:
      "A minute to register — then your whole order and warranty history is in one place.",
    reset: "Reset password",
    resetTitle: "Reset your password",
    resetText:
      "Enter your email address and we will send the recovery link there.",
    ...
    adminAccountNotice:
      "This account belongs to the admin panel. Use the secure admin sign-in.",
    technicianAccountNotice:
      "This account belongs to the technician panel. Use the technician sign-in.",
    marketingOptional:
      "I want to receive campaign and product updates (optional)",
  ...
  accountUi: {
    ...
    noTechnicianProfile:
      "No technician profile is linked to your account. Contact an administrator.",
    jobsAndServiceNotes: "My jobs and service notes",
    technicianIntro:
      "Accept requests, update their status and record the work completed.",
  ...
  service: {
    ...
    publicNotice:
      "This page was opened via QR code. No personal data is shown.",
    model: "Model",
    warrantyStatus: "Warranty status",
    servicePhone: "Service phone",
    qrHint:
      "Scan this code from the label on the door to reach warranty and service details.",
    fullHistoryLocked:
      "The full service history is available to technicians and admins only.",
  ...
  projectDetail: {
    ...
    renewalText:
      "The existing entrance is measured, the opening direction is selected and a door matching the interior is installed. The lock, hinges and insulation are checked at the final stage.",
    projectType: "Project type",
    year: "Year",
    stages: "Work stages",
    stageItems: [
      "Measurement and consultation",
      "Configuration and price confirmation",
  ...
  adminUi: {
    ...
    fields: {
      ...
      slug: "URL slug",
      sku: "SKU",
      basePrice: "Base price (AZN)",
      collection: "Collection",
      style: "Surface style",
      soundInsulationDb: "Sound insulation (dB)",
      defaultWidth: "Default width (mm)",
      defaultHeight: "Default height (mm)",
      minWidth: "Minimum width (mm)",
      maxWidth: "Maximum width (mm)",
      minHeight: "Minimum height (mm)",
      maxHeight: "Maximum height (mm)",
      deliveryDaysMin: "Minimum delivery days",
      deliveryDaysMax: "Maximum delivery days",
      availableOptions: "Options available for this product",
      hex: "Colour code (HEX)",
      requiresOptions: "Required options",
      excludesOptions: "Incompatible options",
    ...
    appointmentDescription:
      "Appointment schedule — technician time conflicts are checked by the system",
    ...
    analyticsSourceNote:
      "Page views are not collected; the figures come from actual database records.",
    ...
    roleMatrixNote:
      "The matrix reflects the permissions enforced in code: the server checks every request with `requireUser`.",
    settingKeys: {
      siteName: "Site name",
      currency: "Currency",
    ...
    funnelSteps: {
      catalog: "Catalogue view",
      product: "Product page",
      configurator: "Configurator opened",
      completed: "Configuration completed",
      cart: "Added to cart",
      checkout: "Checkout started",
      order: "Order",
      configurations: "Saved configuration",
    ...
    discount: {
      codeHint: "Uppercase letters, digits and hyphens",
      scopeHint: "ALL or CATEGORY:<slug>",
      startDate: "Start date",
      percentage: "Percentage",
      amount: "Amount",
      service: "Service",
      allCatalog: "Entire catalog",
      smartDoors: "Smart doors",
