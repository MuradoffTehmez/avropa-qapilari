export const az = {
  ...
  configurator: {
    ...
    constructionLayers: {
      s1: { name: "Xarici polad təbəqə", role: "Zərbəyə davamlı örtük" },
      s2: { name: "Anti-korroziya qrunt", role: "Nəmdən qoruma" },
      s3: { name: "Gücləndirici qabırğalar", role: "Deformasiyaya qarşı karkas" },
      s4: { name: "Mineral yun", role: "Səs və istilik izolyasiyası" },
      s5: { name: "Buxar baryeri", role: "Kondensata qarşı" },
      s6: { name: "Daxili polad təbəqə", role: "Struktur bütövlüyü" },
      s7: { name: "MDF üz paneli", role: "Dekorativ iç səth" },
      s8: { name: "Örtük / şpon", role: "Rəng və faktura" },
      c1: { name: "Kompozit örtük", role: "UV və hava davamlılığı" },
      c2: { name: "Alüminium profil", role: "Ölçü sabitliyi" },
      c3: { name: "Termo körpü kəsici", role: "İstilik itkisinin qarşısı" },
      c4: { name: "Poliuretan köpük", role: "0.79 W/m²K termo nüvə" },
      c5: { name: "Daxili alüminium profil", role: "Struktur" },
      c6: { name: "İç panel", role: "Dekorativ səth" },
      w1: { name: "Lak / yağ örtüyü", role: "Səthin qorunması" },
      w2: { name: "Massiv palıd lamel", role: "Xarici üz qatı" },
      w3: { name: "Çarpaz lamel nüvə", role: "Əyilməyə qarşı sabitlik" },
      w4: { name: "Massiv palıd lamel", role: "Daxili üz qatı" },
      w5: { name: "Lak / yağ örtüyü", role: "Səthin qorunması" },
      m1: { name: "Emal örtüyü", role: "Cızıqlara davamlılıq" },
      m2: { name: "MDF lövhə", role: "Xarici üz" },
      m3: { name: "Bal pətəyi doldurucu", role: "Yüngül karkas" },
      m4: { name: "MDF lövhə", role: "Daxili üz" },
      m5: { name: "Emal örtüyü", role: "Cızıqlara davamlılıq" },
      a1: { name: "Anodlanmış alüminium", role: "Xarici profil" },
      a2: { name: "Termo körpü kəsici", role: "İstilik ayırıcı" },
      a3: { name: "Tempered şüşə paket", role: "İşıq keçirən nüvə" },
      a4: { name: "Termo körpü kəsici", role: "İstilik ayırıcı" },
      a5: { name: "Anodlanmış alüminium", role: "Daxili profil" },
      g1: { name: "Tempered şüşə", role: "Xarici təbəqə" },
      g2: { name: "PVB laylı film", role: "Qırılmaya qarşı" },
      g3: { name: "Tempered şüşə", role: "Daxili təbəqə" },
    },
    showLayer: "göstər",
    hideLayer: "gizlət",
  ...
  adminUi: {
    ...
    fields: {
      ...
      collection: "Kolleksiya",
      style: "Səth stili",
      soundInsulationDb: "Səs izolyasiyası (dB)",
      defaultWidth: "Standart en (mm)",
      defaultHeight: "Standart hündürlük (mm)",
      minWidth: "Minimum en (mm)",
      maxWidth: "Maksimum en (mm)",
      minHeight: "Minimum hündürlük (mm)",
      maxHeight: "Maksimum hündürlük (mm)",
      deliveryDaysMin: "Minimum çatdırılma günü",
      deliveryDaysMax: "Maksimum çatdırılma günü",
      availableOptions: "Məhsul üçün əlçatan seçimlər",
      hex: "Rəng kodu (HEX)",
      requiresOptions: "Tələb etdiyi seçimlər",
      excludesOptions: "Uyğun olmadığı seçimlər",
