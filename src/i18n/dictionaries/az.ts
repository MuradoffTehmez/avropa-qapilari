export const az = {
  ...
  common: {
    ...
    contactResponseTime: "Operatorumuz 1 iş günü ərzində sizinlə əlaqə saxlayacaq.",
    color: "Rəng",
    sections: "Bölmələr",
  ...
  product: {
    ...
    colorsHint: "Xarici və daxili rəng ayrıca seçilir. Aşağıdakı rənglər konfiquratorda mövcuddur.",
    ...
    warrantyQr: "Hər qapıya unikal serial nömrə verilir. Qapının üzərindəki QR kod vasitəsilə zəmanət statusunu və servis tarixçəsini istənilən vaxt yoxlaya bilərsiniz.",
    warrantyExclusions: "Zəmanət mexaniki zədələri, düzgün olmayan istismarı və üçüncü tərəf müdaxiləsini əhatə etmir.",
  ...
  configurator: {
    ...
    priceUnavailable: "Qiyməti hazırda təsdiqləmək mümkün olmadı. Göstərilən məbləğ ilkin hesablamadır.",
  ...
  checkout: {
    ...
    installationAppointmentNotice: "Quraşdırma seçilərsə, sifariş çatdıqdan sonra ayrıca quraşdırma görüşü yaradılır.",
  ...
  repair: {
    ...
    exactTimeNotice: "Dəqiq vaxt operator tərəfindən təsdiqlənir. Usta təyinatı və vaxt konflikti sistemdə yoxlanılır.",
    files: "Fayllar",
    fileUnit: "fayl",
  },
  ...
  auth: {
    ...
    signInText: "Sifarişləri izləyin, saxladığınız dizaynları açın və servis müraciətlərini idarə edin.",
    register: "Hesab yarat",
    registerTitle: "Yeni hesab yaradın",
    registerText: "Bir dəqiqəlik qeydiyyat — sonra bütün sifariş və zəmanət tarixçəniz bir yerdə olur.",
    reset: "Parolu yenilə",
    ...
    adminAccountNotice: "Bu hesab idarəetmə panelinə aiddir. Təhlükəsiz admin girişindən istifadə edin.",
    technicianAccountNotice: "Bu hesab usta kabinetinə aiddir. Usta girişindən istifadə edin.",
    marketingOptional: "Kampaniya və yeniliklər barədə bildiriş almaq istəyirəm (istəyə bağlı)",
  ...
  accountUi: {
    ...
    noOrdersHint: "Kataloqdan qapı seçin və ya konfiquratorda öz variantınızı yığın.",
    ...
    statuses: { new: "Yeni", confirmed: "Təsdiqləndi", scheduled: "Planlaşdırıldı", inProgress: "İcradadır", completed: "Tamamlandı", cancelled: "Ləğv edildi" },
  },
  ...
  projectDetail: {
    ...
    renewalText: "Mövcud giriş ölçülür, açılma istiqaməti seçilir və interyerə uyğun qapı quraşdırılır. Son mərhələdə kilid, menteşə və izolyasiya yoxlanılır.",
    projectType: "Layihə növü",
    year: "İl",
    stages: "İş mərhələləri",
    stageItems: ["Ölçü və məsləhət", "Konfiqurasiya və qiymətin təsdiqi", "Çatdırılma və quraşdırma", "Keyfiyyət yoxlaması və zəmanət"],
  ...
  adminUi: {
    ...
    empty: "Məlumat yoxdur",
    fields: {
      name: "Ad", title: "Başlıq", slug: "URL adı", sku: "Artikul", basePrice: "Baza qiyməti (AZN)", priceDelta: "Qiymət əlavəsi", stock: "Stok", minimum: "Minimum stok", status: "Status", technician: "Usta", technicianId: "Usta kodu", description: "Təsvir", shortDescription: "Qısa təsvir", phone: "Telefon", email: "E-poçt", address: "Ünvan", categorySlug: "Kateqoriya", brandSlug: "Brend", customerName: "Müştəri", amount: "Məbləğ", total: "Cəmi", country: "Ölkə", label: "Başlıq", code: "Kod", rating: "Reytinq", verified: "Təsdiqlənmiş", inStock: "Stokda", featured: "Seçilmiş", onSale: "Endirimdə", warrantyYears: "Zəmanət (il)", text: "Mətn", active: "Aktiv", productName: "Məhsul adı", category: "Kateqoriya", price: "Qiymət (AZN)", categoryName: "Kateqoriya adı", brandName: "Brend adı", optionName: "Option adı", group: "Qrup", compatibleModels: "Uyğun modellər", discountName: "Endirim adı", promoCode: "Promo kod", percentage: "Faiz", endDate: "Bitmə tarixi", addressName: "Ünvan adı", city: "Şəhər", street: "Küçə", building: "Bina", apartment: "Mənzil", content: "Məzmun", component: "Komponent", supplier: "Təchizatçı", pageUrl: "Səhifə URL", seoTitle: "SEO başlığı", metaDescription: "Meta təsvir", canonical: "Canonical", siteName: "Sayt adı", specialization: "İxtisas", serviceArea: "Xidmət ərazisi", supplierName: "Təchizatçı adı", contact: "Əlaqə", deliveryTime: "Çatdırılma müddəti", note: "Qeyd", material: "Material", securityClass: "Təhlükəsizlik sinfi", founded: "Təsis ili", reference: "İstinad", date: "Tarix", startTime: "Başlanğıc saatı", endTime: "Bitmə saatı", type: "Növ", serialNumber: "Serial nömrə", orderNumber: "Sifariş nömrəsi", installationDate: "Quraşdırma tarixi", startDate: "Başlanğıc tarixi", password: "Parol",
    },
    newRecord: "Yeni qeyd",
    ...
    appointmentDescription: "Görüş cədvəli — usta üzrə vaxt toqquşmaları sistemdə yoxlanılır",
    ...
    analyticsSourceNote: "Səhifə baxışı toplanmır; rəqəmlər bazadakı faktiki qeydlərdəndir.",
    ...
    contentPages: { home: "Ana səhifə", about: "Haqqımızda", services: "Xidmətlər", faq: "FAQ", privacy: "Məxfilik siyasəti" },
    roleNames: { CUSTOMER: "Müştəri", TECHNICIAN: "Usta", ADMIN: "Admin" },
    roleUsersTitle: "İstifadəçi rolları",
    roleMatrixNote: "Matris kodda tətbiq olunan səlahiyyətləri əks etdirir: server hər sorğuda `requireUser` ilə yoxlayır.",
    settingKeys: { siteName: "Sayt adı", currency: "Valyuta", defaultLocale: "Əsas dil", locales: "Dəstəklənən dillər", timeZone: "Saat qurşağı", orderPrefix: "Sifariş prefiksi", supportPhone: "Dəstək telefonu", supportEmail: "Dəstək e-poçtu" },
    funnelSteps: { catalog: "Kataloq baxışı", product: "Məhsul səhifəsi", configurator: "Konfiqurator açılışı", completed: "Konfiqurasiya tamamlanması", cart: "Səbətə əlavə", checkout: "Checkout başlanğıcı", order: "Sifariş", configurations: "Saxlanmış konfiqurasiya", quotes: "Qiymət təklifi", orders: "Sifariş", repairs: "Təmir müraciəti", measurements: "Ölçü sorğusu" },
    discount: { codeHint: "Böyük hərf, rəqəm və defis", scopeHint: "ALL və ya CATEGORY:<slug>", startDate: "Başlanğıc tarixi", percentage: "Faiz", amount: "Məbləğ", service: "Xidmət", allCatalog: "Bütün kataloq", smartDoors: "Smart qapılar", freeInstallation: "Pulsuz quraşdırma", threeDoors: "3+ qapı" },
  },
