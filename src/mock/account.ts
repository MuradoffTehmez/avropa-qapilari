    ...
    items: [
      {
        ...
        snapshot: {
          ...
          height: 2050,
          lines: [
            { group: "OUTSIDE_COLOR", value: "oc-ral7016" },
            { group: "INSIDE_COLOR", value: "ic-white" },
            { group: "HANDLE", value: "hd-black" },
            { group: "LOCK", value: "lk-multipoint" },
            { group: "SMART_LOCK", value: "sl-x2" },
            { group: "INSTALLATION", value: "in-full" },
          ],
        },
      },
    ],
...
export const quotes: Quote[] = [
  {
    ...
    status: "SENT",
    customerName: "Test User",
    subject: "Villa Grande 1200 — 1450 × 2350",
    amount: 4180,
  },
];
